 ...
 * @author vishal
 */
public class VoteCastControllerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("Vote Cast Controller Servlet");

        try {
            String userid = (String) session.getAttribute("userid");
            System.out.println("userid in voting controller:" + userid);
            if (userid == null) {
                session.invalidate();
            ...
            if (action.equals("seevote")) {
                System.out.println("seeevote");
                if (cid != null) {
            ...
            if (action.equals("viewcandidate")) {
                
                    ArrayList<CandidateDto> candidateList = UserDao.viewCandidate(userid);
                    request.setAttribute("candidateList", candidateList);
                    rd = request.getRequestDispatcher("showcandidate1.jsp");
